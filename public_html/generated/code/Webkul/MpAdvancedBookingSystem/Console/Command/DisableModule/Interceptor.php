<?php
namespace Webkul\MpAdvancedBookingSystem\Console\Command\DisableModule;

/**
 * Interceptor class for @see \Webkul\MpAdvancedBookingSystem\Console\Command\DisableModule
 */
class Interceptor extends \Webkul\MpAdvancedBookingSystem\Console\Command\DisableModule implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\App\ResourceConnection $resource, \Magento\Framework\Module\Manager $moduleManager, \Magento\Eav\Model\Entity\Attribute $entityAttribute, \Magento\Framework\Module\Status $modStatus)
    {
        $this->___init();
        parent::__construct($resource, $moduleManager, $entityAttribute, $modStatus);
    }
