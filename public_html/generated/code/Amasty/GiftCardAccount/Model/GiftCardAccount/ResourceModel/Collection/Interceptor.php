<?php
namespace Amasty\GiftCardAccount\Model\GiftCardAccount\ResourceModel\Collection;

/**
 * Interceptor class for @see \Amasty\GiftCardAccount\Model\GiftCardAccount\ResourceModel\Collection
 */
class Interceptor extends \Amasty\GiftCardAccount\Model\GiftCardAccount\ResourceModel\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function addCodeTable() : \Amasty\GiftCardAccount\Model\GiftCardAccount\ResourceModel\Collection
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addCodeTable');
        return $pluginInfo ? $this->___callPlugins('addCodeTable', func_get_args(), $pluginInfo) : parent::addCodeTable();
    }

    /**
     * {@inheritdoc}
     */
    public function addOrderTable() : \Amasty\GiftCardAccount\Model\GiftCardAccount\ResourceModel\Collection
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addOrderTable');
        return $pluginInfo ? $this->___callPlugins('addOrderTable', func_get_args(), $pluginInfo) : parent::addOrderTable();
    }

    /**
     * {@inheritdoc}
     */
    public function filterCustomerCards(int $customerId) : \Amasty\GiftCardAccount\Model\GiftCardAccount\ResourceModel\Collection
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterCustomerCards');
        return $pluginInfo ? $this->___callPlugins('filterCustomerCards', func_get_args(), $pluginInfo) : parent::filterCustomerCards($customerId);
    }
