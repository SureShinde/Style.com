...
var config = {
    map: {
        '*': {
            ...
            stripeConnectJs: 'Webkul_MpStripe/js/stripeConnectJs',
            cardJs:'Webkul_MpStripe/js/cardJs',
            customAccount:'Webkul_MpStripe/js/customAccount',
        }
    }
};
...
var config = {
    map: {
        '*': {
            mpSellerSlider: 'Webkul_MpsellersliderTwo/js/seller-slider',
            sellerProfileJsSlider : 'Webkul_MpsellersliderTwo/js/slider-js-1.3',
            manageSlider : 'Webkul_MpsellersliderTwo/js/manage-slider',
            mpColorPickerFunction: 'Webkul_Marketplace/js/color-picker-function',
        }
    },
    paths: {
