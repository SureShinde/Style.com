...
class CreditmemoRepositoryPlugin
{
    ...
    /**
     * Delete created accounts if order contained gift cards
     *
     * @param CreditmemoInterface $creditmemo
     *
     * @throws \Magento\Framework\Exception\CouldNotDeleteException
    ...
    private function deleteGiftCardAccounts(CreditmemoInterface $creditmemo)
    {
        ...
        if ($orderItems = $order->getItems()) {
            foreach ($creditmemo->getItems() as $creditMemoItem) {
                ...
                if ($orderItem && $codes = $orderItem->getProductOptionByCode(
                    GiftCardOptionInterface::GIFTCARD_CREATED_CODES
                )) {
