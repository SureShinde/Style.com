...
class InstallImageData
{
    ...
    private $imageData = [
        [
            ...
            ImageInterface::CODE_POS_X => '290',
            ImageInterface::CODE_POS_Y => '340',
        ...
        [
            ...
            ImageInterface::STATUS => ImageStatus::ENABLED,
            ImageInterface::CODE_POS_X => '338',
            ImageInterface::CODE_POS_Y => '392',
        ...
        [
            ...
            ImageInterface::STATUS => ImageStatus::ENABLED,
            ImageInterface::CODE_POS_X => '190',
            ImageInterface::CODE_POS_Y => '373',
        ...
        [
            ...
            ImageInterface::STATUS => ImageStatus::ENABLED,
            ImageInterface::CODE_POS_X => '48',
            ImageInterface::CODE_POS_Y => '62',
        ...
        [
            ...
            ImageInterface::STATUS => ImageStatus::ENABLED,
            ImageInterface::CODE_POS_X => '50',
            ImageInterface::CODE_POS_Y => '338',
        ...
        [
            ...
            ImageInterface::STATUS => ImageStatus::ENABLED,
            ImageInterface::CODE_POS_X => '101',
            ImageInterface::CODE_POS_Y => '371',
    ...
    public function addImageTemplates($isUpdate = false)
    {
        ...
        foreach ($this->imageData as $imageData) {
            $model = $this->imageRepository->getEmptyImageModel()
                ...
                ->setCodePosX($imageData[ImageInterface::CODE_POS_X])
                ->setCodePosY($imageData[ImageInterface::CODE_POS_Y])
