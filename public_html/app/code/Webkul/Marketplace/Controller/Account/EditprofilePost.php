        ...
        if ($this->getRequest()->isPost()) {
            try {
                ...
                if (empty($errors)) {
                    ...
                    if (array_key_exists('styles', $fields)) {
                        $stylesArray = array_filter($fields['styles']);
                        $styles = serialize($stylesArray);
                        $value->setStyles($styles);
                    }

                    if (array_key_exists('certification', $fields)) {
                        $certificationArray = array_filter($fields['certification']);
                        $certification = serialize($certificationArray);
                        $value->setCertification($certification);
                    }

                    if (array_key_exists('specialties_general', $fields)) {
                        $specialties_generalArray = array_filter($fields['specialties_general']);
                        $specialties_general = serialize($specialties_generalArray);
                        $value->setSpecialtiesGeneral($specialties_general);
                    }

                    if (array_key_exists('specialties_work', $fields)) {
                        $specialties_workArray = array_filter($fields['specialties_work']);
                        $specialties_work = serialize($specialties_workArray);
                        $value->setSpecialtiesWork($specialties_work);
                    }

                    if (array_key_exists('specialties_social', $fields)) {
                        $specialties_socialArray = array_filter($fields['specialties_social']);
                        $specialties_social = serialize($specialties_socialArray);
                        $value->setSpecialtiesSocial($specialties_social);
                    }
                    ...
                    if (array_key_exists('time_zone', $fields)) {
                        $value->setTimeZone($fields['time_zone']);
                    }

                    if (array_key_exists('experience', $fields)) {
                        $value->setExperience($fields['experience']);
                    }
                    if (array_key_exists('title_stylist', $fields)) {
                        $value->setTitleStylist($fields['title_stylist']);
                    }
                    if (array_key_exists('about_me', $fields)) {
                        $value->setAboutMe($fields['about_me']);
                    }
                    if (array_key_exists('zip_code_stylist', $fields)) {
                        $value->setZipCodeStylist($fields['zip_code_stylist']);
                    }

                    if (array_key_exists('training_one', $fields)) {
                        $value->setTrainingOne($fields['training_one']);
                    }
                    if (array_key_exists('training_two', $fields)) {
                        $value->setTrainingTwo($fields['training_two']);
                    }
                    if (array_key_exists('training_three', $fields)) {
                        $value->setTrainingThree($fields['training_three']);
                    }
                    if (array_key_exists('training_four', $fields)) {
                        $value->setTrainingFour($fields['training_four']);
                    }
                    if (array_key_exists('training_five', $fields)) {
                        $value->setTrainingFive($fields['training_five']);
                    }
                    if (array_key_exists('training_six', $fields)) {
                        $value->setTrainingSix($fields['training_six']);
                    }

                    if (array_key_exists('state_stylist', $fields)) {
                        $state = explode('_', $fields['state_stylist']);
                        $stateValue = $state[0];
                        $stateLabel = $state[1];
                        $company_locality = $fields['city_stylist'] . ', ' . $stateLabel;

                        $value->setStateStylist($stateValue);
                        $value->setCompanyLocality($company_locality);
                    }
                    if (array_key_exists('street_stylist', $fields)) {
                        $value->setStreetStylist($fields['street_stylist']);
                    }
                    if (array_key_exists('city_stylist', $fields)) {
                        $value->setCityStylist($fields['city_stylist']);
                    }
                    if (array_key_exists('zoom_api_key_stylist', $fields)) {
                        $value->setZoomApiKeyStylist($fields['zoom_api_key_stylist']);
                    }

                    // if (array_key_exists('company_locality', $fields)) {
                    // }
