...
namespace Webkul\Mpsellerslider\Helper;

use Magento\Framework\App\Filesystem\DirectoryList;

/**
 * Webkul Mpsellerslider Helper
 */
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    /**
     * @var \Webkul\Mpsellerslider\Logger\Logger
     */
    private $logger;
     ...
     * @param \Webkul\Mpsellerslider\Logger\Logger $logger
    ...
    public function __construct(
        ...
        \Webkul\Mpsellerslider\Logger\Logger $logger,
    ...
    public function isModuleEnable()
    {
        try {
            return $this->scopeConfig->getValue(
                'marketplace/general_settings/mpsellerslider_enable',
