    ...
    public function getSellerInfoCollection()
    {
        ...
        if ($customerId != '') {
            ...
            foreach ($collection as $record) {
                ...
                $title_stylist = $record->getTitleStylist();
                // $specialties_general = $record->getSpecialtiesGeneral();
                // $specialties_work = $record->getSpecialtiesWork();
                // $specialties_social = $record->getSpecialtiesSocial();
                // $certification = $record->getCertification();
                $about_me = $record->getAboutMe();
